...
{
    /// <summary>
    /// 提供带参数的导航命令类，建议搭配<see cref="Navigation.NavigateWithParameterStore"/>和<see cref="Navigation.NavigateWithParameterService"/>使用
    /// <para></para>
    ...
    /// </example>
    /// </summary>
    /// <typeparam name="TParameter">导航参数的类型</typeparam>
    public class NavigateWithParameterCommand<TParameter> : CommandBase
    {
        /// <summary>
        /// 导航服务接口的实例
        /// </summary>
        private readonly INavigateWithParameterService<TParameter> _navigateService;

        /// <summary>
        /// 构造函数，初始化导航服务接口的实例
        /// </summary>
        /// <param name="navigateService">导航服务接口的实例</param>
        public NavigateWithParameterCommand(INavigateWithParameterService<TParameter> navigateService)
        {
        ...
        {
            _navigateService.Navigate((TParameter)parameter);
        }
    }
}